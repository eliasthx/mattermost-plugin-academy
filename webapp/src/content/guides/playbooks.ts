...
const playbooks: Guide = {
    ...
    subtitle: 'Six modules covering how runs work, how to work a checklist, how to keep stakeholders updated, how to build a playbook, and how to review a run afterwards.',
